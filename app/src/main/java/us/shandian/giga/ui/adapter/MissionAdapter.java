...
import org.schabi.newpipe.PlayerActivity;
    ...
    private void viewWithFileProvider(Mission mission) {
        if (checkInvalidFile(mission)) return;
            ...
            if (BuildConfig.DEBUG)
                ...
                intent.putExtra(INTENT_VIDEO_TITLE, mission.storage.getName());
                intent.putExtra(INTENT_VIDEO_URL, mission.storage.getUri().toString());
